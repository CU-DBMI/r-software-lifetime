...
All historical versions of R as reported by [`rversions::r_versions()`](https://r-hub.github.io/rversions/reference/r_versions.html). R has adopted [semantic versioning](https://semver.org/) for all verions since version 1.4.1.
